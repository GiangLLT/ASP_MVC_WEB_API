...
namespace WebAPI.Services
{
    public class ProxyRepository : IProxyRepository
    {
        ...
        public ProxyRepository(MyDbContext Context)
        {
            _context = Context;
        }      

        public HeaderVM Create(HeaderVM entity)
        {
            try
            {
                //Type on left is source type, type on right is destination              
                //Mapper.CreateMap<Header, HeaderVM>();
                //Mapper.Map(HeaderVM, Header);
                //Header header = Mapper.Map<HeaderVM>(Header);
                //var empDTO = Mapper.Map<HeaderVM, Header>(head);
        ...
        public List<HeaderVM> GetByID(string ID)
        {
            try
            {
                var All_IDoc = (from s in _context.Idoc_Header
        ...
        public void Update(HeaderVM entity)
        {
            throw new NotImplementedException();
        }
    }
